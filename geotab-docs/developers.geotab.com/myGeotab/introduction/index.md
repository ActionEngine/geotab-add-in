...
See the full list of supported data feed types [here](../apiReference/methods/GetFeed/index.md)
...
You can start using these tools right now by trying the  [.Net examples](https://github.com/Geotab/sdk-dotnet-samples), [JavaScript examples](https://developers.geotab.com/myGeotab/codeSamples/javascriptSamples/) and  [Java examples](https://github.com/Geotab/sdk-java-samples).
...
- When a new pick-up arrives, use the GO device to automatically dispatch a vehicle with a text message.
...
- Ready availability of Add-Ins to instantly integrate into your MyGeotab and Geotab Drive. Visit the  [Geotab Marketplace](http://www.geotab.com/marketplace/)  and the [Developing Add-Ins](https://developers.geotab.com/myGeotab/addIns/developingAddIns/) SDK page to see the available Add-Ins
