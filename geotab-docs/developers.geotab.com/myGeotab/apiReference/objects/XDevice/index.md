...
The minimum allowable value for[MaxSecondsBetweenLogs](https://developers.geotab.com/myGeotab/apiReference/objects/MaxSecondsBetweenLogs/). For[XDevice](index.md)s, this is the same as the default value of 200.0f.
