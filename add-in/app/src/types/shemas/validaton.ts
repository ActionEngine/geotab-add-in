...
export enum ValidationType {
  ...
  ROAD_COUNTER_FUEL_CONSUMPTION = "ROAD_COUNTER_FUEL_CONSUMPTION",
  ROAD_COUNTER_COOLANT_TEMP = "ROAD_COUNTER_COOLANT_TEMP",
  ROAD_COUNTER_EV_BATTERY_DISCHARGE = "ROAD_COUNTER_EV_BATTERY_DISCHARGE",
}
